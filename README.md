          ...
          <div class="locator-card-header">
            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
              ...
              <div class="locator-rating">
                ...
                <span class="count">(${locator.details.reviews || '100+'})</span>
              </div>
            </div>
            ...
            <div class="locator-info-grid">
              ...
              <div class="info-item">
                ...
                <div class="info-content">
                  ...
                  <span class="info-value">${locator.details.entryFee}</span>
                </div>
              </div>
            </div>
          ...
          <div class="provider-card-header">
            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
              ...
              <div class="provider-rating">
                ...
                <span class="count">(${provider.details.reviews || '100+'})</span>
              </div>
            </div>
